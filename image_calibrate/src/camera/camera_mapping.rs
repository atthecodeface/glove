...
use crate::{
    CameraInstance, CameraPolynomial, ModelLineSet, NamedPointSet, Point2D, Point3D, PointMapping,
    PointMappingSet, Quat, Ray,
};
...
// impl CameraMapping for CameraPolynomial {}
