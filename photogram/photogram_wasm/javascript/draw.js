export class Line {
    ...
    add_pt(cxy) {
        ...
        else if (Math.abs(this.last_cxy[0] - cxy[0]) +
    ...
    draw(ctx, style) {
        ...
        for (const c of this.contents) {
            switch (c[0]) {
                ...
                case "a": {
                    ctx.arc(c[1], c[2], c[3], c[4] * d2r, c[5] * d2r);
                    lx = c[1];
                    ly = c[2];
                    break;
                }
                ...
                case "sc": {
                    ctx.transform(c[1], 0, 0, c[2], 0, 0);
                    break;
                }
                case "t": {
                    ctx.transform(1, 0, 0, 1, c[1], c[2]);
                    break;
                }
                case "T": {
                    ctx.transform(c[1], c[2], c[3], c[4], c[5], c[6]);
                    break;
                }
                case "txt": {
