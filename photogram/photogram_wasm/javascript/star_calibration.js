import { WasmCatalog, WasmMat4f64, WasmVec3f64, } from "../pkg/photogram_wasm.js";
import { ZoomedWindow } from "./zoomed_window.js";
import { StarsWebglObj, GridLinesObj, } from "./webgl_canvas.js";
class ImagePoint {
    constructor() {
        this.x = 0;
        this.y = 0;
...
export class StarCalibration {
    ...
    webgl_redraw(webgl, webgl_canvas) {
        ...
        c.set_args(2000, true, 0.2, (y_space_of_1000px / 1000) * grid_line_spacing_in_px, -1000);
        webgl.draw(c);
        c.set_args(2000, false, 0.2, (x_space_of_1000px / 1000) * grid_line_spacing_in_px, -1000);
        webgl.draw(c);
        ...
        c.set_args(2000, true, 0.7, (y_space_of_1000px / 1000) * grid_line_spacing_in_px, -1000);
        webgl.draw(c);
        c.set_args(2000, false, 0.7, (x_space_of_1000px / 1000) * grid_line_spacing_in_px, -1000);
        webgl.draw(c);
