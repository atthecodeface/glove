...
cip --cip 0 list 'XXX.*'
cip image_patch -r ${cip.image} -w patch_m_0.png   "M m.*" "top mensa e tip"
...
cip --cip 1 list 'XXX.*'
cip image_patch -r ${cip.image} -w patch_m_1.png  "M m.*" "top mensa e tip"
...
cip --cip 2 list 'XXX.*'
cip image_patch -r ${cip.image} -w patch_m_2.png    "M m.*" "top mensa e tip"
