...
cip --cip 0 list 'XXX.*'
cip image_patch -r ${cip.image} -w patch_m_0.png    "top mensa e tip"  "M m.*"
...
cip --cip 1 list 'XXX.*'
cip image_patch -r ${cip.image} -w patch_m_1.png    "top mensa e tip" "M m.*"
...
cip --cip 2 list 'XXX.*'
cip image_patch -r ${cip.image} -w patch_m_2.png    "top mensa e tip"  "M m.*"
