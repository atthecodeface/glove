...
set pts "${0}"
--orientation ${orientation_86_to_85}
...
set pts "${0}"
--orientation ${orientation_86_to_88}
quaternion_mapping_pts --xyz "${pts}"
...
--verbose --orientation ${orientation}          read_photo --read /Users/gjstark/Git/Images/Lyon/145A3986.JPG --blend 0.0
...
--verbose --orientation ${orientation}          read_photo --read /Users/gjstark/Git/Images/Lyon/145A3986.JPG --blend ${blend}
